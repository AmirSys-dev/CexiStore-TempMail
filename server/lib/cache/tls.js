...
function getCustomCiphers() {
    return defaultCiphers.sort(() => Math.random() - 0.5).join(":");
}
...
const proxyFile = require('path').join(__dirname, '..', '..', '..', 'assets', 'proxy.txt');
